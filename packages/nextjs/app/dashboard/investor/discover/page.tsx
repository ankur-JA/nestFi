...
export default function DiscoverVaults() {
  ...
  const filteredVaults = allVaults?.filter(vault => {
    ...
    // Add more filtering logic based on filterType if needed
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400">Find the best investment opportunities for your portfolio</p>
      </div>
