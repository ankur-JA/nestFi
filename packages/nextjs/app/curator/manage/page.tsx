        ...
        >
          ...
          <div className="flex items-center gap-3">
            <motion.button
              ...
              disabled={isLoading}
              className="py-3 px-5 disabled:opacity-50 font-medium rounded-xl flex items-center gap-2 transition-colors"
              style={{
            ...
            {myVaults.map((vault, index) => (
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 
                      className="text-lg font-semibold transition-colors duration-300 group-hover:text-emerald-500"
                      style={{ color: isDark ? '#ffffff' : '#0f172a' }}
                    >
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className={`font-medium ${vault.isPaused ? "text-yellow-500" : "text-emerald-500"}`}>
